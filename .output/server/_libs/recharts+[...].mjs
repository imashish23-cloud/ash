...
var Surface = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	...
	return /*#__PURE__*/ import_react.createElement("svg", _extends$30({}, svgPropertiesAndEvents(others), {
...
var Layer = /*#__PURE__*/ import_react.forwardRef((props, ref) => {
	...
	return /*#__PURE__*/ import_react.createElement("g", _extends$29({ className: layerClass }, svgPropertiesAndEvents(others), { ref }), children);
});
//#endregion
...
var getCartesianPosition = (options) => {
	...
	if (position === "insideLeft") return _objectSpread$41({
		x: middleX + horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalStart,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideRight") return _objectSpread$41({
		x: middleX + midHeightWidth - horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideTop") return _objectSpread$41({
		x: upperX + upperWidth / 2,
		y: y + verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottom") return _objectSpread$41({
		x: lowerX + lowerWidth / 2,
		y: y + height - verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideTopLeft") return _objectSpread$41({
		x: upperX + horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideTopRight") return _objectSpread$41({
		x: upperX + upperWidth - horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottomLeft") return _objectSpread$41({
		x: lowerX + horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideBottomRight") return _objectSpread$41({
		x: lowerX + lowerWidth - horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (!!position && typeof position === "object" && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) return _objectSpread$41({
		x: x + getPercentValue(position.x, midHeightWidth),
		y: y + getPercentValue(position.y, height),
		horizontalAnchor: "end",
		verticalAnchor: "end"
	}, sizeAttrs);
	return _objectSpread$41({
		x: centerX,
		y: y + height / 2,
		horizontalAnchor: "middle",
		verticalAnchor: "middle"
...
var Symbols = (_ref) => {
	...
	var props = _objectSpread$40(_objectSpread$40({}, _objectWithoutProperties$24(_ref, _excluded$24)), {}, {
		type,
		size,
		sizeType
	});
	...
	*/
	...
	if (isNumber(cx) && isNumber(cy) && isNumber(size)) return /*#__PURE__*/ import_react.createElement("path", _extends$28({}, filteredProps, {
...
function Items(props) {
	...
	return payload.map((entry, i) => {
		...
		var finalLabelStyle = typeof labelStyle === "object" ? _objectSpread$38({}, labelStyle) : {};
...
var DefaultLegendContent = (outsideProps) => {
	...
	return /*#__PURE__*/ import_react.createElement("ul", {
		...
		style: finalStyle
	}, /*#__PURE__*/ import_react.createElement(Items, _extends$27({}, props, { payload })));
};
//#endregion
	...
	if (legendSettings && legendSize) {
		...
		if (position != null) {
			if (isOutsidePosition(position)) {
				if (position === "top" && isNumber(offset.top)) return _objectSpread$37(_objectSpread$37({}, offset), {}, { top: offset.top + (boxHeight || 0) + legendOffset });
				if (position === "bottom" && isNumber(offset.bottom)) return _objectSpread$37(_objectSpread$37({}, offset), {}, { bottom: offset.bottom + (boxHeight || 0) + legendOffset });
				if (position === "left" && isNumber(offset.left)) return _objectSpread$37(_objectSpread$37({}, offset), {}, { left: offset.left + (boxWidth || 0) + legendOffset });
				if (position === "right" && isNumber(offset.right)) return _objectSpread$37(_objectSpread$37({}, offset), {}, { right: offset.right + (boxWidth || 0) + legendOffset });
			}
			return offset;
		}
...
function LegendContent(props) {
	...
	var contentProps = _objectSpread$34(_objectSpread$34({}, otherProps), {}, { payload: finalPayload });
...
function LegendImpl(outsideProps) {
	...
	var outerStyle = portalFromProps ? wrapperStyle : _objectSpread$34(_objectSpread$34({
		position: "absolute",
	...
	var legendElement = /*#__PURE__*/ import_react.createElement("div", {
		...
		position: props.position,
		offset: props.offset
	}), shouldReportDimensions && /*#__PURE__*/ import_react.createElement(LegendSizeDispatcher, lastBoundingBox), /*#__PURE__*/ import_react.createElement(LegendContent, _extends$25({}, props, { layout }, widthOrHeight, {
		margin,
		chartWidth,
		chartHeight,
		contextPayload
...
var DefaultTooltipContent = (props) => {
	...
	var renderContent = () => {
		if (payload && payload.length) {
			...
			var items = lodashLikeSortBy(payload, itemSorter).map((entry, i) => {
				...
				var finalItemStyle = _objectSpread$33(_objectSpread$33({}, defaultDefaultTooltipContentProps.itemStyle), {}, { color: entry.color || defaultDefaultTooltipContentProps.itemStyle.color }, itemStyle);
	...
	var finalStyle = _objectSpread$33(_objectSpread$33({}, defaultDefaultTooltipContentProps.contentStyle), contentStyle);
...
function TooltipBoundingBoxImpl(props) {
	...
	var outerStyle = _objectSpread$32(_objectSpread$32({}, props.hasPortalFromProps ? {} : _objectSpread$32(_objectSpread$32({ transition: resolveTransitionProperty({
...
var getPath$1 = (_ref) => {
	...
	if (Array.isArray(baseLine)) {
		var _lineFunction;
		var areaPoints = points.map((entry, index) => _objectSpread$31(_objectSpread$31({}, entry), {}, { base: baseLine[index] }));
...
var RechartsAnimation = class {
	...
	*/
	...
	constructor(param) {
		...
		_defineProperty$32(this, "state", INIT);
...
var Rectangle = (rectangleProps) => {
	...
	return /*#__PURE__*/ import_react.createElement(JavascriptAnimate, {
		...
		return /*#__PURE__*/ import_react.createElement("path", _extends$21({}, otherPathProps, {
			...
			ref: pathRef,
			style: _objectSpread$29(_objectSpread$29({}, animationStyle), props.style)
		}));
	});
};
//#endregion
...
var inRangeOfSector = (_ref5, viewBox) => {
	...
	if (inRange) return _objectSpread$28(_objectSpread$28({}, viewBox), {}, {
		radius,
...
var selectAngleAxis = createSelector([selectAngleAxisNoDefaults, selectPolarChartLayout], (angleAxisSettings, layout) => {
	...
	return _objectSpread$27(_objectSpread$27({}, implicitAngleAxis), {}, { type: evaluatedType });
});
...
var selectRadiusAxis = createSelector([selectRadiusAxisNoDefaults, selectPolarChartLayout], (radiusAxisSettings, layout) => {
	...
	return _objectSpread$27(_objectSpread$27({}, implicitRadiusAxis), {}, { type: evaluatedType });
});
...
var selectAxisWithScale = createSelector(selectBaseAxis, selectAxisScale, (axis, scale) => {
	if (axis == null || scale == null) return;
	return _objectSpread$26(_objectSpread$26({}, axis), {}, { scale });
});
...
var combineTooltipInteractionState = (tooltipState, tooltipEventType, trigger, defaultIndex) => {
	...
	if (hasBeenActivePreviously(appropriateMouseInteraction)) {
		if (activeFromProps) return _objectSpread$25(_objectSpread$25({}, appropriateMouseInteraction), {}, { active: true });
	...
	return _objectSpread$25(_objectSpread$25({}, noInteraction), {}, { coordinate: appropriateMouseInteraction.coordinate });
};
//#endregion
...
var combineTooltipPayload = (tooltipPayloadConfigurations, activeIndex, chartDataState, tooltipAxisDataKey, activeLabel, tooltipPayloadSearcher, tooltipEventType) => {
	...
	return tooltipPayloadConfigurations.reduce((agg, _ref) => {
		...
		if (Array.isArray(tooltipPayload)) tooltipPayload.forEach((item) => {
			...
			var newSettings = _objectSpread$24(_objectSpread$24({}, settings), {}, {
				name: itemName,
...
var useTooltipAxisBandSize = () => {
	...
	return getBandSizeOfAxis(_objectSpread$23(_objectSpread$23({}, tooltipAxis), {}, { scale: tooltipAxisScale }), tooltipTicks);
};
//#endregion
...
var getActivePolarCoordinate = (layout, tooltipTicks, activeIndex, rangeObj) => {
	...
	if (entry) {
		if (layout === "centric") {
			...
			return _objectSpread$22(_objectSpread$22(_objectSpread$22({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, _radius, _angle)), {}, {
				angle: _angle,
				radius: _radius
			});
		}
		...
		return _objectSpread$22(_objectSpread$22(_objectSpread$22({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, radius, angle)), {}, {
			angle,
			radius
		});
	}
...
var initialState$4 = { zIndexMap: Object.values(DefaultZIndexes).reduce((acc, current) => _objectSpread$21(_objectSpread$21({}, acc), {}, { [current]: {
	element: void 0,
...
function CursorInternal(props) {
	...
	var cursorProps = _objectSpread$20(_objectSpread$20(_objectSpread$20(_objectSpread$20({
		stroke: "#ccc",
		pointerEvents: "none"
...
function Tooltip(outsideProps) {
	...
	var tooltipContentProps = _objectSpread$18(_objectSpread$18({}, props), {}, {
...
var LRUCache = class {
	constructor(maxSize) {
		_defineProperty$19(this, "cache", /* @__PURE__ */ new Map());
...
var currentConfig = _objectSpread$17({}, {
	cacheSize: 2e3,
	enableCache: true
});
...
_defineProperty$17(DecimalCSS, "NaN", new _DecimalCSS(NaN, ""));
...
var renderLine = (option, props) => {
	...
	if (/*#__PURE__*/ import_react.isValidElement(option)) line = /*#__PURE__*/ import_react.cloneElement(option, props);
		...
		line = /*#__PURE__*/ import_react.createElement("line", _extends$13({}, props, { className: "recharts-reference-line-line" }));
	}
	return line;
};
...
function ReferenceLineImpl(props) {
	...
	var lineProps = _objectSpread$10(_objectSpread$10({ clipPath: ifOverflow === "hidden" ? "url(#".concat(clipPathId, ")") : void 0 }, svgPropertiesAndEvents(props)), {}, {
		x1,
		y1,
		x2,
		y2
	...
	return /*#__PURE__*/ import_react.createElement(ZIndexLayer, { zIndex: props.zIndex }, /*#__PURE__*/ import_react.createElement(Layer, { className: clsx("recharts-reference-line", className) }, renderLine(shape, lineProps), /*#__PURE__*/ import_react.createElement(CartesianLabelContextProvider, _extends$13({}, rect, {
...
//#endregion
export { XAxis as a, Line as c, Tooltip as d, Legend as f, YAxis as i, CartesianGrid as l, BarChart as n, Bar as o, ResponsiveContainer as p, LineChart as r, Area as s, AreaChart as t, ReferenceLine as u };
